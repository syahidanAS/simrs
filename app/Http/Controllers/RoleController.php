        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $btn .= "<a href='" . route('setting.access-utilities.roles.edit', ['id' => Main::hashIdsEncode($row->id)]) . "' class='btn btn-warning text-light btn-sm' type='button' id='editMenu'>Ubah</a>";;
