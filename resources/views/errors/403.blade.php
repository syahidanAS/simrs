...
<body>
    <div id="container_anim">
        <div id="lock" class="key-container">
            <?xml version="1.0" standalone="no"?><!-- Generator: Gravit.io --><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <p id="credit" style="color: #ffffff;"><a href="{{ route('home') }}">Kembali ke Beranda</a></p>
