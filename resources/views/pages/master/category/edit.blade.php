    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Perbaharui Data Kategori Produk</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formEditUnit" action="{{ route('master.categories.update') }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" type="text" name="codeEdit" id="codeEdit" readonly>
                    </div>
