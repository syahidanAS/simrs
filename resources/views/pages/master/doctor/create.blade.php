...
<div class="content-body">
    <div class="container-fluid">
        ...
        <form class="card p-4" id="formTambahDokter" action="{{ route('master.doctors.store') }}" method="POST">
            @csrf
            <div class="container">
                ...
                <div class="card-footer">
                    <button id="btnSubmit" type="submit" class="btn btn-primary btn-sm">Simpan</button>
                </div>
            </div>
        </form>
    </div>
