...
<script>
    ...
    $(document).ready(function () {
        ...
        let selectedSpecialist = '{{ $doctor->specialist_id }}';
        let newOption = new Option('{{ $doctor->specialist->name }}', selectedSpecialist, true, true);
        $("#specialist_id").append(newOption).trigger('change');
        $("#gender").select2({
        });
    });
</script>
