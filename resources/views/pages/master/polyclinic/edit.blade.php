...
<div class="content-body">
    <div class="container-fluid">
        ...
        <form class="card p-4" id="formTambahPoli" action="{{ route('master.polyclinics.update') }}" method="POST">
            @csrf
            <div class="container">
                ...
                <div class="card-body pt-4 row">
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3 form-group">
                            <label for="kd_poli">Kode Poli<span class="text-danger">*</span> <small
                                    style="font-size: 11px;" class="text-primary">(Kode poli terisi
