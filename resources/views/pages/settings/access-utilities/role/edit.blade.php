...
<div class="app-content my-4">
    <form id="formUpdateRole" action="{{ route('setting.access-utilities.roles.update') }}">
        @csrf
        <div class="container">
            ...
            <div class="card-body pt-4 row">
                ...
                <div class="col-sm-6">
                    <div class="mb-3 form-group">
                        ...
                        <input class="form-control" type="text" name="name" id="name" placeholder="Masukan nama role"
                            value="{{ $foundRole->name }}" required>
                    </div>
                    <div class="mb-3 form-group">
